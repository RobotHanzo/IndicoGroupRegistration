...
blueprint.add_url_rule('/manage/registration/<int:reg_form_id>/groups/remind', 'remind_forming_groups',
                       management.RHRemindFormingGroups, methods=('GET', 'POST'))
blueprint.add_url_rule('/manage/registration/<int:reg_form_id>/groups/remind/preview',
...
blueprint.add_url_rule('/manage/registration/<int:reg_form_id>/registrations/<int:registration_id>/group-balance',
                       'record_balance_payment', management.RHRecordBalancePayment, methods=('POST',))
